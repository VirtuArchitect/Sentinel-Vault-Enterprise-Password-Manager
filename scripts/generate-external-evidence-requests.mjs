...
const requests = [
  ...
  },
  {
    ...
    commands: [
      ...
      "pnpm release:source-migration -- --status pilot --source-system <source-system> --column-map <column-map.json> --source-adapter-evidence <migration-evidence.json> --normalized-import <normalized-import.csv> --normalized-import-validation <normalized-import-validation.json> --storage-migration-evidence <storage-migration-evidence.json> --tenant-isolation-evidence <tenant-isolation-evidence.json> --out <source-migration-evidence.json>",
  ...
  },
  {
    ...
    commands: [
      ...
      "pnpm validate:extension-package -- --package <sentinel-vault-autofill.zip> --out <browser-extension-package-validation.json>",
