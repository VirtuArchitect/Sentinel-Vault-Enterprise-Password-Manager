...
- External evidence request markdown validation so owner-facing handoff docs cannot drift from the strict request pack.
...
- Phase handoff checklist production expected-status summary sourced from the shared release-gate requirements.
...
- Phase decision record markdown command coverage validation for owner-facing go/no-go decisions.
...
- Phase signoff matrix markdown command coverage validation for owner-facing approval views.
