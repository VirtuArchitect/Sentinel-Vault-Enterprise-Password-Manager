...
test("phase review bundle hashes final review artifacts", () => {
  ...
  try {
    ...
    assert.equal(manifest.commandCoverageSummary.signoffValidatorCommandCount, 19);
    ...
    assert.equal(manifest.commandCoverageSummary.waiverValidatorCommandCount, 19);
    ...
    assert.equal(manifest.markdownCoverageSummary.validatorCommandCount, 19);
    ...
    assert.equal(validation.validatorCommandCount, 19);
...
test("phase review release mode accepts approved waivers", () => {
  ...
  try {
    ...
    assert.equal(result.approvedWaiverCount, 22);
