...
test("phase review bundle hashes final review artifacts", () => {
  ...
  try {
    ...
    assert.equal(manifest.commandCoverageSummary.signoffValidatorCommandCount, 15);
    ...
    assert.equal(manifest.commandCoverageSummary.waiverValidatorCommandCount, 15);
    ...
    assert.equal(manifest.markdownCoverageSummary.validatorCommandCount, 15);
