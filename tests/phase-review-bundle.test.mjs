...
test("phase review bundle hashes final review artifacts", () => {
  ...
  try {
    ...
    assert.equal(manifest.commandCoverageSummary.signoffValidatorCommandCount, 14);
    ...
    assert.equal(manifest.commandCoverageSummary.waiverValidatorCommandCount, 14);
    ...
    assert.equal(manifest.markdownCoverageSummary.validatorCommandCount, 14);
