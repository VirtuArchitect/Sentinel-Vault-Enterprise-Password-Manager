...
pnpm validate:external-evidence -- --requests ".\artifacts\deployment\pilot\external-evidence-requests.json" --markdown ".\artifacts\deployment\pilot\external-evidence-requests.md" --strict
...
pnpm validate:deployment-redaction -- --report ".\artifacts\deployment\pilot\deployment-redaction-report.json" --bundle ".\artifacts\deployment\pilot\deployment-evidence-bundle.json" --require-ready
...
pnpm report:phase-readiness -- --bundle ".\artifacts\deployment\pilot\deployment-evidence-bundle.json" --external-requests ".\artifacts\deployment\pilot\external-evidence-requests.json" --target "production" --out ".\artifacts\deployment\pilot\phase-readiness.json" --markdown-out ".\artifacts\deployment\pilot\phase-readiness.md"
pnpm validate:phase-readiness -- --report ".\artifacts\deployment\pilot\phase-readiness.json" --bundle ".\artifacts\deployment\pilot\deployment-evidence-bundle.json" --external-requests ".\artifacts\deployment\pilot\external-evidence-requests.json" --target "production" --require-ready
...
pnpm validate:phase-actions -- --register ".\artifacts\deployment\pilot\phase-action-register.json" --markdown ".\artifacts\deployment\pilot\phase-action-register.md" --phase-gate ".\artifacts\deployment\pilot\phase-gate-validation.json" --external-requests ".\artifacts\deployment\pilot\external-evidence-requests.json"
...
pnpm validate:phase-gaps -- --matrix ".\artifacts\deployment\pilot\phase-gap-matrix.json" --markdown ".\artifacts\deployment\pilot\phase-gap-matrix.md" --bundle ".\artifacts\deployment\pilot\deployment-evidence-bundle.json" --external-requests ".\artifacts\deployment\pilot\external-evidence-requests.json"
...
pnpm validate:phase-decision -- --record ".\artifacts\deployment\pilot\phase-decision-record.json" --markdown ".\artifacts\deployment\pilot\phase-decision-record.md" --phase-gate ".\artifacts\deployment\pilot\phase-gate-validation.json" --phase-actions ".\artifacts\deployment\pilot\phase-action-register.json" --phase-gaps ".\artifacts\deployment\pilot\phase-gap-matrix.json"
...
pnpm validate:phase-signoffs -- --matrix ".\artifacts\deployment\pilot\phase-signoff-matrix.json" --markdown ".\artifacts\deployment\pilot\phase-signoff-matrix.md" --phase-decision ".\artifacts\deployment\pilot\phase-decision-record.json" --phase-actions ".\artifacts\deployment\pilot\phase-action-register.json"
...
pnpm validate:phase-intake -- --intake ".\artifacts\deployment\pilot\phase-evidence-intake.json" --markdown ".\artifacts\deployment\pilot\phase-evidence-intake.md" --external-requests ".\artifacts\deployment\pilot\external-evidence-requests.json" --phase-gaps ".\artifacts\deployment\pilot\phase-gap-matrix.json" --phase-signoffs ".\artifacts\deployment\pilot\phase-signoff-matrix.json"
...
pnpm validate:phase-attachments -- --inventory ".\artifacts\deployment\pilot\phase-attachment-inventory.json" --markdown ".\artifacts\deployment\pilot\phase-attachment-inventory.md" --intake ".\artifacts\deployment\pilot\phase-evidence-intake.json"
...
pnpm validate:phase-waivers -- --register ".\artifacts\deployment\pilot\phase-waiver-register.json" --markdown ".\artifacts\deployment\pilot\phase-waiver-register.md" --attachments ".\artifacts\deployment\pilot\phase-attachment-inventory.json" --phase-decision ".\artifacts\deployment\pilot\phase-decision-record.json"
...
pnpm package:release-archive -- --dir ".\artifacts\deployment\pilot" --out ".\artifacts\deployment\pilot\production-release-archive-manifest.json"
pnpm validate:release-archive -- --manifest ".\artifacts\deployment\pilot\production-release-archive-manifest.json" --dir ".\artifacts\deployment\pilot" --target "production" --require-clean --require-ready --require-approved-waivers
...
Use the `--fail-on-blockers` readiness command as the release or CI gate for a completed deployment bundle. Use the `--require-approved-waivers` review and closure commands only after every missing or redaction-flagged evidence item has an approved waiver, future expiry date, approval reference, and compensating control. Use `validate:release-gate` as the final production gate that composes deployment evidence validation, phase completion, phase readiness, final review, closure archive provenance, approved waivers, and clean source-state checks. Package and validate the release archive after the gate report so the final closure archive and production gate output are hash-bound together. These commands are expected to fail for newly generated placeholder workspaces until the deployment-specific evidence is replaced or explicitly approved.

For production bundles, `pnpm validate:deployment-evidence` also requires Postgres HA approval evidence to be `approved`, source migration and tenant isolation evidence to be `production`, browser extension identity and rollout evidence to be `production`, the native companion release evidence to be `production`, credential-provider approval evidence to be `approved`, KMS/HSM provider evidence to be `active`, KMS/HSM SDK approval evidence to be `approved`, the Phase 5 connector evidence to be `certified`, the ITSM work-note evidence to be `production`, the SIEM receiver rotation evidence to be `certified`, the Windows signing execution evidence to be `signed`, and environment-bearing evidence files to match the bundle environment.
