...
For production bundles, `pnpm validate:deployment-evidence` also requires the Phase 5 connector evidence to be `certified`, the ITSM work-note evidence to be `production`, the SIEM receiver rotation evidence to be `certified`, and all three evidence files to match the bundle environment.
